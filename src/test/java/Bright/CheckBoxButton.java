...
public class CheckBoxButton {
    ...
    public void CheckBoxButton(){
        WebElement bmwCheckboxButton = driver.findElement(By.id("bmwcheck"));
        bmwCheckboxButton.click();

        WebElement benzCheckboxButton = driver.findElement(By.id("benzcheck"));
        benzCheckboxButton.click();
